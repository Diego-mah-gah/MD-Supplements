...
<div id="mainBar">
    ...
    <div class="container">
        <h1 class="text-center my-4">Whey Protein</h1>
        <div class="row">
            <div class='col-12 col-md-4 mb-4'>
                <div class='card h-100'>
                    <img src="../../model/imgs/whey.avif" class="card-img-top" alt="Whey Protein">
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-4 mb-4">
                            <div class="d-flex align-items-center justify-content-center" style="margin-top: 10px;">
                                <span style="font-size: 1.5rem; font-weight: bold; color: #be100d;">R$ 199,90</span>
                            </div>
                        </div>
                    </div>
                    </form>
